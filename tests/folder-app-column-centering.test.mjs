...
test('docker folder application column centers the content block between mover and menu', () => {
    ...
    assert.match(dockerCss, /\.folder-inner\s*\{[\s\S]*align-items:\s*center/);
    assert.match(dockerCss, /\.folder-inner\s*\{[\s\S]*text-align:\s*center/);
...
test('vm folder application column centers the content block between mover and menu', () => {
    ...
    assert.match(vmCss, /\.folder-inner\s*\{[\s\S]*align-items:\s*center/);
    assert.match(vmCss, /\.folder-inner\s*\{[\s\S]*text-align:\s*center/);
});
