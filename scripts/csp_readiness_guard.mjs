...
const explicitHtmlSinkReviews = new Map([
    ...
    ['src/folderview.plus/usr/local/emhttp/plugins/folderview.plus/scripts/folder.editor.chrome.js:469', 'buildTopChrome returns plugin-authored editor chrome with no persisted-value interpolation.'],
    ['src/folderview.plus/usr/local/emhttp/plugins/folderview.plus/scripts/folder.editor.chrome.js:483', 'The action bar shell contains plugin-authored static markup only.'],
    ...
    ['src/folderview.plus/usr/local/emhttp/plugins/folderview.plus/scripts/folderviewplus.js:6387', 'Summary-card values pass through buildBasicSummaryCardHtml, which escapes every interpolated value.'],
    ...
    ['src/folderview.plus/usr/local/emhttp/plugins/folderview.plus/scripts/folderviewplus.theme-workspace.js:319', 'The empty theme list contains plugin-authored static markup only.'],
    ['src/folderview.plus/usr/local/emhttp/plugins/folderview.plus/scripts/folderviewplus.theme-workspace.js:327', 'Theme names, source metadata, warnings, identifiers, and statuses are escaped at their interpolation boundaries.'],
