...
const expectedOrder = [
  ...
  'folderviewplus.safe-dom.js',
  'folderviewplus.page-bootstrap.js',
  'folderviewplus.fatal-banner.js',
  'folderviewplus.settings-watchdog.js',
  'folderviewplus.utils.js',
  'folderviewplus.ui.js',
  'folderviewplus.request.js',
  'folderviewplus.runtime-snapshot.js',
  ...
  'folderviewplus.diagnostics-view.js',
  'folderviewplus.activity-diagnostics.js',
  'folderviewplus.settings-tree.js',
  'folderviewplus.tree-integrity.js',
  'folderviewplus.mobile-reorder.js',
  ...
  'folderviewplus.js',
  'folderviewplus.settings-manifest.js',
