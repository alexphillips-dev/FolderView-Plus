...
test('folder.js icon upload parsing is resilient to empty and noisy endpoint responses', () => {
    ...
    assert.match(folderIconApiScript, /requestClient\.uploadJson\(uploadApiPath, formData/);
    assert.match(folderIconApiScript, /requestClient\.postJson\(uploadApiPath, body/);
    ...
    assert.match(folderIconApiScript, /const uploadCustomIconFileInline = async \(file, options = \{\}\) =>/);
    assert.match(folderIconApiScript, /icon_inline_name/);
    assert.match(folderIconApiScript, /icon_inline_data/);
    assert.match(folderIconApiScript, /timeoutMs:\s*30000/);
