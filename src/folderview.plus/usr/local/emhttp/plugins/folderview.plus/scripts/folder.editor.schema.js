...
(function fvplusFolderEditorSchemaScope(window) {
    ...
    const createModernSchema = (deps = {}) => {
        const sectionMeta = Object.freeze({
            ...
            webuiProfiles: Object.freeze({ title: 'WebUI Profiles', description: 'Create named groups that open only selected Docker container WebUIs.', icon: 'fa-external-link', advanced: false, supportsDefaults: false, supportsRevert: false }),
        ...
        const sectionFieldNames = Object.freeze({
            ...
            preview: Object.freeze([
                ...
                'preview_status',
                'preview_hide_nested_items',
                'preview_child_folder_depth',
                'preview_webui',
                'preview_logs',
                'preview_console',
            ...
            webuiProfiles: Object.freeze(['webui_profiles']),
        ...
        const sectionDefaultValues = Object.freeze({
            preview: Object.freeze({
                ...
                folder_update_highlight: false,
                preview_text_width: '',
                preview_rows: '1',
                preview_overflow: 'default',
                preview_grayscale: false,
                preview_hover_animation: 'none',
                preview_status: 'symbol',
                preview_hide_nested_items: false,
                preview_child_folder_depth: '0',
                preview_webui: false,
                preview_logs: false,
            ...
            status: Object.freeze({
                ...
                status_color_text: deps.defaultFolderStatusColors?.text || '#ffffff',
                status_color_text_auto: true,
        ...
        const sectionChangeLabels = Object.freeze({
            ...
            preview_row_separator: 'Preview row separators',
            preview_row_separator_color: 'Row separator color',
            preview_border: 'Preview border',
            preview_border_color: 'Preview border color',
            preview_border_width: 'Preview border thickness',
            preview_border_glow: 'Preview border glow',
            ...
            status_color_text: 'Status text color',
            status_color_text_auto: 'Status text theme default',
            status_color_lock: 'Lock status colors',
