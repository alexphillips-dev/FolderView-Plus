...
const budgets = [
  {
    ...
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_JS_BYTES', 560000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_JS_GZIP_BYTES', 105000),
  },
  {
...
const totalJsBudget = envInt('FVPLUS_MAX_TOTAL_JS_BYTES', 1050000);
