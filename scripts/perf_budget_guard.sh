...
const budgets = [
  {
    ...
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_JS_BYTES', 510000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_JS_GZIP_BYTES', 96000),
  },
  {
...
const totalJsBudget = envInt('FVPLUS_MAX_TOTAL_JS_BYTES', 960000);
