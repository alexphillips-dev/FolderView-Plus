...
const explicitHtmlSinkReviews = new Map([
    ...
    ['src/folderview.plus/usr/local/emhttp/plugins/folderview.plus/scripts/folderviewplus.js:6172', 'Summary-card values pass through buildBasicSummaryCardHtml, which escapes every interpolated value.'],
