...
const explicitHtmlSinkReviews = new Map([
    ['src/folderview.plus/usr/local/emhttp/plugins/folderview.plus/scripts/docker.js:1310', 'Port endpoints and protocols are escaped by buildDockerPortEndpoint before the markup builder returns.'],
    ['src/folderview.plus/usr/local/emhttp/plugins/folderview.plus/scripts/docker.js:3430', 'The loading overlay contains plugin-authored static markup only.'],
