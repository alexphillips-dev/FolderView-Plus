...
test('folder editor uses searchable parent picker and grouped tab panels', () => {
    ...
    assert.doesNotMatch(folderCss, /\.fv-editor-panel\[data-editor-panel="member-manager"\],[\s\S]*\.fv-editor-panel\[data-editor-panel="dashboard"\]\s*\{[\s\S]*grid-column:\s*1 \/ -1;/);
