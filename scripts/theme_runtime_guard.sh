...
require_contains "${DIAGNOSTICS_JS}" 'run_theme_self_heal:[[:space:]]*Object\.freeze\(\{' 'theme self-heal diagnostics action mapping'
require_contains "${DIAGNOSTICS_JS}" "handler:[[:space:]]*'runThemeSelfHeal\(\)'" 'theme self-heal diagnostics handler wiring'
