...
const budgets = [
  ...
  {
    path: 'scripts/folderviewplus.runtime-parity.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_RUNTIME_PARITY_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_RUNTIME_PARITY_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_RUNTIME_PARITY_JS_BYTES', 5000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_RUNTIME_PARITY_JS_GZIP_BYTES', 1500),
  },
  {
    path: 'scripts/folderviewplus.settings-sections.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_SETTINGS_SECTIONS_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_SETTINGS_SECTIONS_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_SETTINGS_SECTIONS_JS_BYTES', 12000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_SETTINGS_SECTIONS_JS_GZIP_BYTES', 3000),
  },
  {
    path: 'scripts/folderviewplus.setup-assistant.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_SETUP_ASSISTANT_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_SETUP_ASSISTANT_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_SETUP_ASSISTANT_JS_BYTES', 25000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_SETUP_ASSISTANT_JS_GZIP_BYTES', 7000),
  },
  {
    path: 'scripts/folderviewplus.smart-detect-config.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_SMART_DETECT_CONFIG_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_SMART_DETECT_CONFIG_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_SMART_DETECT_CONFIG_JS_BYTES', 12000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_SMART_DETECT_CONFIG_JS_GZIP_BYTES', 3000),
  },
  {
    path: 'scripts/folderviewplus.starter-templates.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_STARTER_TEMPLATES_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_STARTER_TEMPLATES_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_STARTER_TEMPLATES_JS_BYTES', 70000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_STARTER_TEMPLATES_JS_GZIP_BYTES', 16000),
  },
  {
    path: 'scripts/folderviewplus.diagnostics-view-model.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_DIAGNOSTICS_VIEW_MODEL_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_DIAGNOSTICS_VIEW_MODEL_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_DIAGNOSTICS_VIEW_MODEL_JS_BYTES', 12000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_DIAGNOSTICS_VIEW_MODEL_JS_GZIP_BYTES', 3500),
  },
  {
    path: 'scripts/folderviewplus.diagnostics-view.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_DIAGNOSTICS_VIEW_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_DIAGNOSTICS_VIEW_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_DIAGNOSTICS_VIEW_JS_BYTES', 18000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_DIAGNOSTICS_VIEW_JS_GZIP_BYTES', 4500),
  },
  {
    path: 'scripts/folderviewplus.activity-diagnostics.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_ACTIVITY_DIAGNOSTICS_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_ACTIVITY_DIAGNOSTICS_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_ACTIVITY_DIAGNOSTICS_JS_BYTES', 30000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_ACTIVITY_DIAGNOSTICS_JS_GZIP_BYTES', 8000),
  },
  {
    path: 'scripts/folderviewplus.support-bundle-preview.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_SUPPORT_BUNDLE_PREVIEW_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_SUPPORT_BUNDLE_PREVIEW_JS_GZIP_BYTES',
  ...
  {
    path: 'scripts/folderviewplus.download-diagnostics.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_DOWNLOAD_DIAGNOSTICS_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_DOWNLOAD_DIAGNOSTICS_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_DOWNLOAD_DIAGNOSTICS_JS_BYTES', 30000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_DOWNLOAD_DIAGNOSTICS_JS_GZIP_BYTES', 7000),
  },
  {
  ...
  },
  {
    ...
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_SETTINGS_TREE_JS_BYTES', 35000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_SETTINGS_TREE_JS_GZIP_BYTES', 8000),
  },
  {
    path: 'scripts/folderviewplus.tree-integrity.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_TREE_INTEGRITY_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_TREE_INTEGRITY_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_TREE_INTEGRITY_JS_BYTES', 22000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_TREE_INTEGRITY_JS_GZIP_BYTES', 5500),
  },
  {
    path: 'scripts/folderviewplus.mobile-reorder.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_MOBILE_REORDER_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_MOBILE_REORDER_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_MOBILE_REORDER_JS_BYTES', 5000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_MOBILE_REORDER_JS_GZIP_BYTES', 2000),
  },
  {
    path: 'scripts/folderviewplus.folder-editor.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_FOLDER_EDITOR_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_FOLDER_EDITOR_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_FOLDER_EDITOR_JS_BYTES', 55000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_FOLDER_EDITOR_JS_GZIP_BYTES', 13000),
  },
  {
    path: 'scripts/folderviewplus.settings-health.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_SETTINGS_HEALTH_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_SETTINGS_HEALTH_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_SETTINGS_HEALTH_JS_BYTES', 80000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_SETTINGS_HEALTH_JS_GZIP_BYTES', 18000),
  },
  {
    path: 'scripts/folderviewplus.settings-workspaces.js',
  ...
  },
  {
    ...
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_BULK_ASSIGNMENT_SHARED_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_BULK_ASSIGNMENT_SHARED_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_BULK_ASSIGNMENT_SHARED_JS_BYTES', 28000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_BULK_ASSIGNMENT_SHARED_JS_GZIP_BYTES', 7000),
  },
  {
  ...
  {
    path: 'scripts/folderviewplus.runtime-actions.js',
    maxBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_RUNTIME_ACTIONS_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_FOLDERVIEWPLUS_RUNTIME_ACTIONS_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_RUNTIME_ACTIONS_JS_BYTES', 35000),
    maxGzipBytes: envInt('FVPLUS_MAX_FOLDERVIEWPLUS_RUNTIME_ACTIONS_JS_GZIP_BYTES', 9000),
  },
  {
  ...
  {
    path: 'scripts/docker.runtime.actions.js',
    maxBytesEnv: 'FVPLUS_MAX_DOCKER_RUNTIME_ACTIONS_JS_BYTES',
    maxGzipBytesEnv: 'FVPLUS_MAX_DOCKER_RUNTIME_ACTIONS_JS_GZIP_BYTES',
    maxBytes: envInt('FVPLUS_MAX_DOCKER_RUNTIME_ACTIONS_JS_BYTES', 60000),
    maxGzipBytes: envInt('FVPLUS_MAX_DOCKER_RUNTIME_ACTIONS_JS_GZIP_BYTES', 14000),
  },
  {
    path: 'scripts/vm.js',
